  ...
  return (
    <div ref={pageRef} className="route-view">
      ...
      <main id="main">
        ...
        <section className="writing section reveal" id="writing">
              ...
              {projects.map((project, index) => (
                <article className={`project${index === 0 ? " project-stillcam" : index === 1 ? " project-check" : index === 2 ? " project-writing-space" : ""}`} key={project.name}>
                  <div className={`project-media ${project.mediaClass}`}>
                    {project.image ? <img {...project.image} loading="lazy" /> : (
                  ...
                  <div className="project-copy">
                    <span className="project-no">{String(index + 1).padStart(2, "0")}</span><h3>{project.name}</h3>
                    <p>{project.description}</p><small>{project.roles}</small>
                    {project.href && <a className="text-link" href={project.href} target="_blank" rel="noopener">{project.linkLabel}</a>}
                  </div>
                </article>
              ))}
            </div>
        ...
        <section className="work section reveal" id="work">
          ...
          <div className="wrap">
            <div className="work-head">
              ...
              <p>I work close to founders and teams, bringing structure to busy work and momentum to useful ideas. The short version is here; the full detail lives in my CV.</p>
            </div>
        ...
        <section className="links section reveal" id="links">
          <div className="wrap">
